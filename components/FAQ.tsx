  ...
  return (
    <section className="section-dark py-24 px-6">
      <div className="max-w-3xl mx-auto">
        <h2 className="font-serif font-bold text-accent text-3xl sm:text-4xl text-center mb-14 leading-snug">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-16">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2.5 bg-[#25D366] text-white font-bold text-xs tracking-[0.18em] uppercase py-5 hover:bg-[#1ebe5d] transition-colors"
          >
          ...
          <a
            href="#preco"
            className="flex-1 bg-accent text-primary font-bold text-xs tracking-[0.18em] uppercase py-5 text-center hover:bg-accent/90 transition-colors"
          >
